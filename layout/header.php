    ...
    <div class="row">
				...
				<div class="col-xs-6"> 
					...
					<a href="index.php?page=pocetna">	
							...
							<img src="pictures\Logo.png" class="img-responsive" height="130" width="230">  
...
<nav class="navbar navbar-inverse ">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
        ...
        <li id="pocetna">
            <a class="nounderline hvr-grow-shadow" href="index.php?page=pocetna" ><p class="navbar_text"><span class="glyphicon glyphicon-home"></span>&nbsp;Почетна</p></a>
        </li>
                
        <li id="rangiraj">
            <a class="nounderline hvr-grow-shadow" href="index.php?page=rangiraj"><p class="navbar_text"><span class="glyphicon glyphicon-film"></span>&nbsp;Рангирај</p></a>
        </li>
                
        <li id="rezultati">
            <a class="nounderline hvr-grow-shadow" href="index.php?page=rezultati"><p class="navbar_text"><span class="glyphicon glyphicon-list"></span>&nbsp;Резултати</p></a> 
        </li>
        
        <li id="zanas">

<a class="nounderline hvr-grow-shadow" href="index.php?page=zanas"><p class="navbar_text"><span class="glyphicon glyphicon-info-sign"></span>&nbsp;За нас</p></a>
        </li>
