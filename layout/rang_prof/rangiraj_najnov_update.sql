...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 06, 2015 at 04:27 PM
...
INSERT INTO `korisnici` (`id_korisnik`, `mail`) VALUES
(1, 'deni');
...
CREATE TABLE IF NOT EXISTS `profesori` (
  ...
  `prosecna_ocena` decimal(1,1) NOT NULL,
  `odgovornost` int(11) NOT NULL,
...
INSERT INTO `profesori` (`id_profesor`, `ime_prof`, `prezime_prof`, `rejting_na_profesori`, `prosecna_ocena`, `odgovornost`) VALUES
(1, 'Сашо', 'Коцевски', 0, '0.0', 0),
...
INSERT INTO `prof_rang` (`id_prof`, `id_korisnik`, `odgovornost`, `predavanja`, `literatura`, `ocena`) VALUES
(1, 1, 2, 3, 4, 5);
...
CREATE TABLE IF NOT EXISTS `univerzitet` (
  ...
  `rejting_na_univeritet` float NOT NULL,
...
INSERT INTO `univerzitet` (`id_univerzitet`, `ime_univerzitet`, `rejting_na_univeritet`) VALUES
(1, 'Универзитет „Гоце Делчев“', 0);
...
ALTER TABLE `fakultet_rang`
  ...
  ADD CONSTRAINT `fakultet_rang_ibfk_1` FOREIGN KEY (`id_fakultet`) REFERENCES `fakulteti` (`id_fakultet`);
